...
export default function Home(){
 ...
 function openVehicleBooking(car:Vehicle){setLeadType('vehicle booking');setLeadMessage(`I want to book ${car.brand} ${car.model} ${car.variant||''} (${car.year}) listed at ₹${Number(car.asking_price).toLocaleString('en-IN')}. Please confirm availability and booking terms before any payment. Vehicle ID: ${car.id}`);setLeadOpen(true)}
