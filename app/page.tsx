...
export default function Home(){
 ...
 <section className="hero"><div className="heroText">
  ...
  <div className="row" style={{marginTop:16,gap:10,flexWrap:"wrap"}}>
   <button onClick={()=>openLead("vehicle purchase")}>Get Car Options</button>
   <button className="secondary" onClick={()=>openLead("vehicle sale")}>Sell My Car</button>
   <button className="secondary" onClick={()=>whatsapp("Hello Rohilla Drive, I want help buying or selling a car in Ambala.")}>WhatsApp Now</button>
  </div>
