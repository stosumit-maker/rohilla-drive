...
export default function InventoryClient(){
 ...
 return <main>
  <section className="hero" style={{paddingTop:45,paddingBottom:45}}><div className="heroText"><span>ROHILLA DRIVE INVENTORY</span><h1>Find the right vehicle.<br/><span className="lifeLine">Full inventory, separate from the homepage.</span></h1><p>Search the complete published inventory here by brand, model, year, fuel, category or city.</p></div></section>
