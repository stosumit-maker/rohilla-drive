...
const realtimeNeeds=[
 ["translation","Website / Message Translation","Public page localization, multilingual messages, operator view and customer replies.","GOOGLE_TRANSLATE_API_KEY"],
 ["realtime_translation","Realtime Speech Interpreter","Secure browser speech-to-speech interpretation for Admin, Dealer and Partner Language Desks.","OPENAI_API_KEY"],
 ["speech","Speech / TTS Layer","Speech transcription and translated voice output. Realtime can use OpenAI; optional Google speech stack can also be connected.","OPENAI_API_KEY or GOOGLE_CLOUD_SERVICE_ACCOUNT_JSON"],
 ["telephony","Exotel / Telephony Stream","Indian phone number/call routing plus bidirectional live audio stream to the Rohilla translation gateway.","EXOTEL account + API credentials + caller ID + gateway host"],
 ["multimodal_ai","Rohilla Multimodal AI","Vehicle/poster/RC understanding, number-plate privacy flags, creative reasoning and structured extraction.","OPENAI_API_KEY (or ROHILLA_AI_PROVIDER_KEY)"]
] as const;
