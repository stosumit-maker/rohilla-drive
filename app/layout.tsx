...
export const metadata: Metadata = {
  ...
  description: "Buy, sell, verify, maintain, protect and manage vehicles through ROHILLA DRIVE in Ambala City and the growing Rohilla automotive network.",
  applicationName: "ROHILLA DRIVE",
  alternates: { canonical: "/", languages },
  manifest: "/manifest.webmanifest",
  openGraph: { type: "website", url: site, siteName: "ROHILLA DRIVE", title: "ROHILLA DRIVE — Complete Vehicle & Mobility Network", description: "New and pre-owned vehicles, verification, services, Trusted Assist, dealers and automotive partners through one connected network.", images: [{ url: "/rohilla-drive-logo.svg", alt: "ROHILLA DRIVE" }] },
  twitter: { card: "summary_large_image", title: "ROHILLA DRIVE — Complete Vehicle & Mobility Network", description: "Buy, sell, verify and manage the complete vehicle life through Rohilla Drive.", images: ["/rohilla-drive-logo.svg"] },
...
const organizationSchema = {
  ...
  sameAs: ["https://www.instagram.com/rohillamultibrandcars/","https://youtube.com/shorts/hqYTgiIaEko"],
};
