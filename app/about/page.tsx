    ...
    <main style={{maxWidth:980,margin:"0 auto",padding:"110px 20px 56px",fontFamily:"Arial,Helvetica,sans-serif"}}>
      <section style={{background:"#0b1220",color:"white",borderRadius:24,padding:"34px 28px",marginBottom:22}}>
        ...
        <p style={{fontSize:20,lineHeight:1.55,maxWidth:780,marginBottom:0}}>
          ROHILLA DRIVE by Rohilla Multibrand Cars is based in Ambala City, Haryana. Customers can browse cars, sell a vehicle, request a new car and get vehicle assistance from one website.
        </p>
      </section>

      <section style={{display:"grid",gridTemplateColumns:"repeat(auto-fit,minmax(240px,1fr))",gap:14,marginBottom:22}}>
        {[
          ["Buy Cars","Browse current used-car inventory.","/inventory"],
          ["New Cars","Tell us the new car you are looking for.","/new-vehicles"],
          ["Sell Your Car","Send your vehicle details and private photos.","/sell"],
          ["Vehicle Services","Inspection, verification, repairs, RC transfer and more.","/verify"],
          ["Business Hub","OEM/authorised dealers, pre-owned dealers and automotive partners can register or log in.","/business-hub"],
          ["CarMentor","Tell us your budget or preferred car and check matching inventory.","/assistant"],
        ].map(([title,copy,href])=>(
