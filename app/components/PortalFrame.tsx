...
const routeTitles:Record<string,string>={
 ...
 "/admin/add-vehicle":"Inventory Publishing",
 "/admin/connections":"Integrations & Connections",
 "/admin/deal-rooms":"Deal Management",
 "/admin/finance":"Transactions, Margin & RC",
 "/admin/growth":"Marketing Studio",
 "/admin/language":"Language Operations",
 "/admin/new-vehicles":"New Vehicle Desk",
...
export default function PortalFrame({portal,nav,children}:Props){
 ...
 return <div className="portal-frame">
  ...
  <div className="portal-page-context" data-no-translate="true">
   <div><span>ROHILLA DRIVE BUSINESS SUITE</span><h1>{title}</h1></div>
   <span className="portal-context-role">{portalNames[portal]}</span>
  </div>
  {children}
 </div>
}
