...
export default function VerifyVehicle() {
  ...
  return <main>
    <header><div className="brand"><b>ROHILLA DRIVE</b><small>Vehicle Check</small></div><a className="call" href="/">← Home</a></header>
    <section className="hero"><div className="heroText"><span>VEHICLE CHECK</span><h1>Check a Car Before You Buy</h1><p>Send the registration number and your contact details. We’ll review available records.</p></div></section>
    <section className="section"><div className="card" style={{maxWidth:720,margin:"0 auto"}}><div className="body">
      {submitted ? <div className="success"><h2>Request submitted ✓</h2><p>Verification ID: <b>{submitted}</b></p><p>We’ll review available records and contact you with the next step. Any applicable fee must be confirmed before payment.</p><a className="call" href="/">Back to Rohilla Drive</a></div> : <>
        <h2>Vehicle Verification Request</h2><p>Enter the registration number and your contact details.</p>
    ...
    <section className="section dark"><div className="about"><h2>Official-source information</h2><p>Government records depend on official portal availability and access rules.</p><div className="quickLeadBtns"><a className="call" href="https://echallan.parivahan.gov.in/" target="_blank" rel="noreferrer">Official eChallan</a><a className="call" href="https://parivahan.gov.in/" target="_blank" rel="noreferrer">Parivahan</a></div></div></section>
